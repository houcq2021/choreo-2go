...
const UUID = process.env.UUID || '750f215c-faf2-4976-ad4c-c49445226c91'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.zenbeam.gq';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjlmOGUzZjYzZjMwMjc1Y2YxZjc1Y2I5YzA2YjEwODMiLCJ0IjoiYWQyNjIwZGItOWJkZS00M2Q4LWIxNDgtZjAzMzJiNWNjZWFkIiwicyI6Ik56ZzJNelprTURRdE16UTNPQzAwTW1Jd0xXSTJZVFF0WVdRellXWmxaV1k0TWpobCJ9';
const CFIP = process.env.CFIP || 'fbi.gov';
const NAME = process.env.NAME || 'Choreo-eu';
